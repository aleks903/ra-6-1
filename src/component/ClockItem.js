          ...
          <svg width="150px" height="150px">
            <g transform="translate(75,75)">
              <g id="hour" transform={rotateArrow.hour}>
                <line strokeWidth="6" y2="-45" strokeLinecap="round" stroke="blue" opacity=".5" />
              </g>
              <g id="minute" transform={rotateArrow.minute}>
                <line strokeWidth="4" y2="-70" strokeLinecap="round" stroke="green" opacity=".9" />
              </g>
              <g id="second" transform={rotateArrow.second}>
                <line strokeWidth="2" y1="10" y2="-75" strokeLinecap="round" stroke="red" />
              </g>
            </g>
          </svg>
          <p className='timer'>
